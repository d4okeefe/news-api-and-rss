...
const nyt_addresses = [
  {
    title: 'topstories',
    section: 'topstories',
    api_route: '/api/new-york-times/topstories',
    url_ext: 'topstories/v2/home.json',
  },
  {
    title: 'opinions',
    section: 'topstories',
    api_route: '/api/new-york-times/topstories/opinions',
    url_ext: 'topstories/v2/opinion.json',
  },
  {
    title: 'science',
    section: 'topstories',
    api_route: '/api/new-york-times/topstories/science',
    url_ext: 'topstories/v2/science.json',
  },
  {
    title: 'sports',
    section: 'topstories',
    api_route: '/api/new-york-times/topstories/sports',
    url_ext: 'topstories/v2/sports.json',
  },
  {
    title: 'world',
    section: 'topstories',
    api_route: '/api/new-york-times/topstories/world',
    url_ext: 'topstories/v2/world.json',
  },
  {
    title: 'books',
    section: 'topstories',
    api_route: '/api/new-york-times/topstories/books',
    url_ext: 'topstories/v2/books.json',
  },
  {
    title: 'movie reviews',
    section: 'movies',
    api_route: '/api/new-york-times/movie-reviews',
    url_ext: 'movies/v2/reviews/picks.json',
  },
  {
    title: 'F1',
    section: 'search',
    api_route: '/api/new-york-times/articlesearch/f1',
