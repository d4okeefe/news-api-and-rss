...
const sci_am_addresses = [
  {
    title: 'news',
    api_route: '/api/scientific-american/news',
    url_ext: 'ScientificAmerican-Global',
  },
  {
    title: 'science',
    api_route: '/api/scientific-american/science',
    url_ext: 'basic-science',
  },
  {
    title: 'mind',
    api_route: '/api/scientific-american/mind',
    url_ext: 'sciam/mind-and-brain',
  },
  {
    title: 'health',
    api_route: '/api/scientific-american/health',
    url_ext: 'sciam/health-and-medicine',
  },
  {
    title: 'tech',
    api_route: '/api/scientific-american/tech',
